/*                                                                    
YieldBox Token - The Biggest $BUSD Reflection Token with APY 1,171,519.7%!
7% - $BUSD Reflections - YBX BUSD Reflection
1% - BuyBack & Burn - The Bonfire
4% - Liquidity Pool - LP
1% - YieldBox Treasury - YBT
2% - Exit Fee
Website: https://yieldbox.io
Dashboard: https://app.yieldbox.io
Telegram: https://t.me/yieldboxio
Twitter: https://twitter.com/yieldboxio
*/
...
contract YieldBox is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "YieldBox";
    string constant _symbol = "$YBX";
    ...
    uint256 public yieldBoxDividendFee = 70;
    uint256 public yieldBoxTreasuryFee = 10;
    uint256 public yieldBoxBonfireFee  = 10;
    uint256 public nftHolderFee = 20;
    uint256 public totalFee            = yieldBoxTreasuryFee + yieldBoxDividendFee + liquidityFee + yieldBoxBonfireFee;
    uint256 public feeDenominator      = 1000;
    uint256 public sellFee             = 20 + nftHolderFee;
    ...
    uint256 private constant MAX_SUPPLY = 10 * (10**10) * (10**_decimals);
    ...
    constructor (address newOwner) Auth(newOwner) {
        ...
        treasuryFeeReceiver = 0x7ad6f8841f05A74C7390FD3b902bF95072cB38B1;
        autoLiquidityReceiver = 0x6a4fe81C916632982240a582f5B386fCF7c66323;
        nftHolderReceiver = 0x0018c6F5f6208f43D1EbF853c708655E7cDA981D;
        bonFire = 0x0000000000000000000000000000000000000000;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToBurn = tokensToSell.div(totalFee).mul(yieldBoxBonfireFee);
        ...
        uint256 totalBNBFee = totalFee.sub(liquidityFee.div(2)).sub(yieldBoxBonfireFee);
        
        uint256 amountBNBLiquidity = amountBNB.mul(liquidityFee).div(totalBNBFee).div(2);
        uint256 amountBNBReflection = amountBNB.mul(yieldBoxDividendFee).div(totalBNBFee);
        uint256 amountBNBTreasury = amountBNB.mul(yieldBoxTreasuryFee).div(totalBNBFee);
